...
이 알고리즘이랑 [kabsch](/kabsch) 알고리즘이랑 합쳐보기 위해서 이것저것 만졌다. 타겟과 가까운데 속도가 너무 빠른 상태이면 감속시키고 노이즈를 추가했다. 기존의 kabsch는 정지해있어서 생물로 만들자니 정지한 채로 따라오기만 했는데 flocking과 합치니 훨씬 유동적으로 움직인다. 
